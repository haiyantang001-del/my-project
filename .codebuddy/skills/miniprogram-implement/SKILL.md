...
13. **⚠️ LOCAL IMAGES IN CSS**: NEVER use `background-image: url(...)` with local paths in SCSS/CSS. WeChat error: "本地资源图片无法通过 WXSS 获取". Use `<Image>` component instead - see below
